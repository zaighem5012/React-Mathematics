...
//       {Data.Qdata.map((user) => (
//         <div>
//         <Random nbr={user.qnbr} Question_1={user.question1} Question_2={user.question2} funasprop = {<input type='number' value={userInput} onChange={onChangeHnadler}/>}/>
//       </div>
//       ))}
//     </div>
